	...
	if request.method == 'POST':
		...
		try:       
			...
			if comment is not "":
				...
				val = (teacher,"18013672",subject,sec1_string,sec2_string,sec3_string,sec4_string,sec5_string,pos_val,neu_val,neg_val,comment,sen_val,score_val)
...
with app.app_context():
	def getsentiment(comment):
		...
		#res = requests.post('https://csentiment.herokuapp.com/getSentiment', json=dictToSend)
